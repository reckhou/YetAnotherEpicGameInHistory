...
public class GameDirector : MonoBehaviour
{
  ...
  Dictionary <int, DirectorEvent> KillDict;
  // killcount-data
  List<int> KillList;
  // killcounts
  Dictionary <int, DirectorEvent> EventDict;
  // eventID-data
  ...
  public void Event (int eventID)
  {
    ...
    if (eventID == 0) {
      ...
      HandController.Instance.SetHand (1);
      ...
      HandController.Instance.SetHand (999);
    }
  }
...
//				}
        ...
        if (KillDict [cur].archID >= 0) {
          ...
          AchievementController.Instance.FinishAchievement (KillDict [cur].archID);
          HandController.Instance.AddHand ();
        }
        // update event
